...
description: >-
  Use when users need help brainstorming, ideation, generating creative ideas,
  content planning, product features, marketing campaigns, strategic planning,
  creative writing, innovation workshops, QA test cases, breaking through
  creative blocks, or any task requiring structured idea generation. Also use
  for competitive analysis, UX brainstorming, feature prioritization, user story
  mapping, backlog refinement, solution design exploration, and systematic
  exploration of problem spaces. Triggers: 头脑风暴, 构思, 创意生成, 策划, 方案
  探讨, 点子, 灵感, 创新, 发散思维, 需求挖掘, 功能设计, 营销策略, 竞品分析, 方案对比
---
