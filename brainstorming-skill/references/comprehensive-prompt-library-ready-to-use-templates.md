...
1. Customer perspective (What do they need?)
2. Competitor perspective (How would they solve this?)
3. Employee perspective (What would make our team excited?)
4. Investor perspective (What would excite board members?)
...
- Resource constraint: [specific limitation]
- Time constraint: [timeline]
- Technical constraint: [what's possible]

For EACH idea:
- How it works within constraints
...
1. What core problem we solve (or stopped solving)
2. What's become obsolete
3. What customers take for granted
